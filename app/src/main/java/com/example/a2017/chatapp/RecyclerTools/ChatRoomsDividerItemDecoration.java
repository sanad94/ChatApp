...
public class ChatRoomsDividerItemDecoration extends RecyclerView.ItemDecoration
{
    private static final int [] attrs = new int []{android.R.attr.listDivider};
    private Drawable drawable;
    private Context context;

    public ChatRoomsDividerItemDecoration(Context context)
    {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state)
    {
        ...
        for (int i = 0 ; i < parent.getChildCount() ; i++)
        {
            ...
            final int imageWidth = child.findViewById(R.id.roomImage).getLayoutParams().width;
            final TextView textView = (TextView) child.findViewById(R.id.name);
